...
<body>
    <div class="container-bars">
        <ol>
            ...
            <li><a href="otras_citas.php?usuario=<?php echo $_GET["usuario"] ?>"><i class="fas fa-file-invoice"></i>Otras Citas</a></li>
            <li><a href="crear_cita.php?usuario=<?php echo $_GET["usuario"] ?>"><i class="fas fa-chart-line"></i>Creacion de Citas</a></li>
            <li><a href="actividades.php?usuario=<?php echo $_GET["usuario"] ?>"><i class="fab fa-accusoft"></i>Actividades</a></li>
            <li><a href="index.php" target="_blank"><i class="far fa-times-circle"></i>Salir</a></li>
        </ol>
    </div>
    <?php
